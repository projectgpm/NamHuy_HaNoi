...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                      ...
                      <dx:LayoutItem Caption="Khách hàng">
                          <LayoutItemNestedControlCollection>
                              <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                  ...
                                  <asp:SqlDataSource ID="dsKhachHang" runat="server" ConnectionString="<%$ ConnectionStrings:KobePaintConnectionString %>" SelectCommand="SELECT [IDKhachHang], [HoTen], [MaKhachHang] FROM [khKhachHang] WHERE [LoaiKhachHangID] &lt;&gt; 2 AND ChiNhanhID =@ChiNhanhID">
                                      <SelectParameters>
    ...
    <asp:SqlDataSource ID="dsChiTiet" runat="server" ConnectionString="<%$ ConnectionStrings:KobePaintConnectionString %>" 
        SelectCommand="spDoanhThuChiNhanh" SelectCommandType="StoredProcedure">
        <SelectParameters>
