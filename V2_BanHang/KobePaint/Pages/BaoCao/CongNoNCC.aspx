<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CongNoNCC.aspx.cs" Inherits="KobePaint.Pages.BaoCao.CongNoNCC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <dx:ASPxFormLayout ID="formThongTin" ClientInstanceName="formThongTin" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Công nợ nhà cung cấp" Width="100%">
                <Items>
                            ...
                            <dx:LayoutItemNestedControlContainer runat="server">
                                ...
                                <dx:ASPxGridView ID="gridKhachHang" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridKhachHang" DataSourceID="dsKhachHang" KeyFieldName="IDKhachHang" Width="100%" OnCustomColumnDisplayText="gridKhachHang_CustomColumnDisplayText">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MaKhachHang" Caption="Mã NCC" VisibleIndex="1">
                                            <CellStyle HorizontalAlign="Center">
                                            </CellStyle>
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="TongTienHang" Caption="Tổng tiền mua hàng" VisibleIndex="6">
...
<CellStyle Font-Bold="True"></CellStyle>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Tổng tiền trả hàng" FieldName="TienTraHang" ShowInCustomizationForm="True" VisibleIndex="7">
                                            <PropertiesTextEdit DisplayFormatString="N0">
                                            </PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                    <TotalSummary>
                                        <dx:ASPxSummaryItem DisplayFormat="N0" FieldName="TongTienHang" ShowInColumn="Tổng tiền mua hàng" SummaryType="Sum" />
                                        <dx:ASPxSummaryItem DisplayFormat="N0" FieldName="TienTraHang" ShowInColumn="Tổng tiền trả hàng" SummaryType="Sum" />
