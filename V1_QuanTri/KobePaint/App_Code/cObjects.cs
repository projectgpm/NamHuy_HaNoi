...
namespace KobePaint.App_Code
{
    ...
    public class oReportChuyenKho
    {
        ...
        public string NgayTao { get; set; }
        public List<oChiTietChuyenKho> listProduct { get; set; }
    }
    [Serializable]
    public class oChiTietChuyenKho
    {
        public int STT { get; set; }
        public string MaHang { get; set; }
        public string TenHangHoa { get; set; }
        public string DVT { get; set; }
        public int SoLuong { get; set; }
        public oChiTietChuyenKho(int sTT, string maHang, string tenHangHoa, string dvt, int soluong)
        {
            // TODO: Complete member initialization
            this.STT = sTT;
            this.MaHang = maHang;
        ...
        public oChiTietChuyenKho()
        {
            // TODO: Complete member initialization
        }

        public oChiTietChuyenKho(oChiTietChuyenKho x)
        {
            // TODO: Complete member initialization
            this.STT = x.STT;
            this.MaHang = x.MaHang;
