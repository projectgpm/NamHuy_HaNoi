...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxGridView ID="gridChiTietXuatKho" ClientInstanceName="gridChiTietXuatKho" runat="server" AutoGenerateColumns="False" DataSourceID="dsChiTietNhapKho" KeyFieldName="ID" Width="100%" OnCustomColumnDisplayText="gridChiTietNhapKho_CustomColumnDisplayText" OnHtmlRowPrepared="gridChiTietNhapKho_HtmlRowPrepared">
        ...
        <Columns>
            ...
            <dx:GridViewDataDateColumn Caption="Ngày đặt" VisibleIndex="2" FieldName="NGAYDAT">
            ...
            <dx:GridViewDataTextColumn Caption="Tên khách hàng" VisibleIndex="4" Width="150px" FieldName="TENKHACHHANG">
            ...
            <dx:GridViewDataTextColumn Caption="Người nhập" VisibleIndex="12" FieldName="TENNHANVIEN">
            ...
            <dx:GridViewDataTextColumn Caption="Trạng thái" VisibleIndex="13" FieldName="TRANGTHAI" Visible="False">
            </dx:GridViewDataTextColumn>
        </Columns>
